...
# capsule-proxy HelmRelease spec.postRenderers extends the
...
#
# RELOCATED (2026-05-06) from the hub-targeted outer Flux
...
#
# The jq check against the LIVE chart-rendered Role remains
